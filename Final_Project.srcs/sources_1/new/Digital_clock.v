...
assign en1 = (en&&outsec0==9) ?1:0;
assign en2 = (en&&outsec0==9&&outsec1==5||(enmin))? 1:0;
assign en3 = (en&&outsec0==9&&outsec1==5&&outmin0==9)||(enmin&&(outmin0==9&&~UpDown||outmin0==0&&UpDown)) ?1:0;
assign en4 = (en&&outsec0==9&&outsec1==5&&outmin0==9&&outmin1==5||(enhours)) ? 1:0;
assign en5 = (en&&outsec0==9&&outsec1==5&&outmin0==9&&outmin1==5&&outhours0==9||((enhours&&(outhours0==9&&~UpDown||outhours0==0&&UpDown)))) ? 1:0;
